...
/**
 * FCB packet classifier - cuckoo per-bucket
 *
 * Initialize the FCB stack for every packets passing by.
 * The classification is done using one cuckoo hashtable per bucket. Hence,
 * when some flows are migrated the do_migrate function must be called.
 *
