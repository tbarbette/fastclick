#ifndef CLICK_IPFlowRRSwitch_HH
#define CLICK_IPFlowRRSwitch_HH
 ...
 */
class IPFlowRRSwitch : public BatchElement {

    public:

        IPFlowRRSwitch() CLICK_COLD;
        ~IPFlowRRSwitch() CLICK_COLD;

        const char *class_name() const { return "IPFlowRRSwitch"; }
