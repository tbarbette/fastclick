/**
 * Generate Click IPLookup rules out of a trace.
...
// sudo bin/click --dpdk -l 0-0 --socket-mem 62,0 --huge-dir /mnt/hugepages -v -- conf/rule-gen/gen-iplookup-rules.click
