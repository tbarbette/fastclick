 ...
 * This version is similar to switch-2ports-vanilla but use a compound element, and
 * shows how Classifier works and how a few IP elements work.
 * This configuration is intended for userlevel Click using standard Kernel I/O (eg PCAP or Socket)
 * Eg launch with:
...
elementclass Input { $label |
    ...
    c[0] -> Strip(14) ->  CheckIPHeader() -> IPPrint($label) -> Unstrip(14) -> output;
    c[1] -> output;
