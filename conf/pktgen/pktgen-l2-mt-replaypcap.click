...
//Yes you have to copy the MAC as hex :) :)
...
d :: DPDKInfo(NB_SOCKET_MBUF  2040960 , NB_SOCKET_MBUF 8192)
...
//Deactivated
receiveIN :: FromDPDKDevice($rxport, VERBOSE $rxverbose, MAC $INsrcmac, PROMISC true, PAUSE none, NDESC 0, MAXTHREADS 4, NUMA false, ACTIVE 0)
...
elementclass Receiver { $mac, $dir |
 ...
 -> c :: Classifier(0/$mac,-)
    ...
    -> magic :: {[0] -> RoundRobinSwitch() => [0-3]; Idle->[4]}

    c[1] //Not for this computer or broadcasts
    -> Discard;

magic[0] -> tsd0 ::  NoTimestampDiff(gen0/rt, OFFSET 42, N  1000000 , SAMPLE 10 ) -> Unstrip(14) ->  avg0 :: AverageCounterIMP(IGNORE $ignore) -> Discard;  tsd0[1] -> Print('WARNING: Untimestamped packet on thread 0', 64) -> Discard;
magic[1] -> tsd1 ::  NoTimestampDiff(gen1/rt, OFFSET 42, N  1000000 , SAMPLE 10 ) -> Unstrip(14) ->  avg1 :: AverageCounterIMP(IGNORE $ignore) -> Discard;  tsd1[1] -> Print('WARNING: Untimestamped packet on thread 1', 64) -> Discard;
magic[2] -> tsd2 ::  NoTimestampDiff(gen2/rt, OFFSET 42, N  1000000 , SAMPLE 10 ) -> Unstrip(14) ->  avg2 :: AverageCounterIMP(IGNORE $ignore) -> Discard;  tsd2[1] -> Print('WARNING: Untimestamped packet on thread 2', 64) -> Discard;
magic[3] -> tsd3 ::  NoTimestampDiff(gen3/rt, OFFSET 42, N  1000000 , SAMPLE 10 ) -> Unstrip(14) ->  avg3 :: AverageCounterIMP(IGNORE $ignore) -> Discard;  tsd3[1] -> Print('WARNING: Untimestamped packet on thread 3', 64) -> Discard;
