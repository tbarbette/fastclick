/*
 * This is a dual flow version of pktgen.click, sending two UDP flows at max rate to two DPDK ports and expect to receive the packets back on the opposite port to display statistics.
 *
 * Please read pktgen.click before for full comprehension !
 */
define($block true)
