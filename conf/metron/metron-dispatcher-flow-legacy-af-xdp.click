 ...
 *                      Module: Metron agent
 *                    Platform: FastClick
 *                 Network I/O: Regular kernel interfaces (using DPDK AF_XDP socket)
 ...
 * using AF_XDP sockets via the respective DPDK PMD. Note that XDP requires
 * a Linux kernel version > 4.18. More information about AF_XDP PMD can be
 * found at:
...
define(
	$iface0         eth_af_packet0,
	$iface1         eth_af_packet1,
